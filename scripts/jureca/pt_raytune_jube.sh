...
#SBATCH -o logs_slurm/log.out
#SBATCH -e logs_slurm/log.err
...
ml --force purge && ml Stages/2024 GCC/12.3.0 Python/3.11.3 CUDA/12 cuDNN/8.9.5.29-CUDA-12 NCCL/default-CUDA-12 Apptainer-Tools/2024
...
python3 -u $PWD/mlpf/pyg_pipeline.py --train --data-dir /p/project/jureap57/cern/tensorflow_datasets/clusters --config parameters/pytorch/pyg-clic.yaml --hpo HPO_test --ray-cpus 48 --gpus 4 --num-workers 8 --prefetch-factor 8 --gpu-batch-multiplier 8 --num-epochs 2 --ntrain 5000 --nvalid 5000 --raytune-num-samples 1

echo 'HPO done.'

touch logs_slurm/job_done
